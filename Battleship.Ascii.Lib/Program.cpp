...
namespace Battleship::Ascii
{
  ...
  void Program::StartGame()
  {
    ...
    do
    {
      ...
      std::cout << rang::style::bold << rang::fg::green << "Enter coordinates for your shot:" << rang::style::reset << " (ex: B5)" << std::endl;
      ...
      if (isHit)
      {
        ...
        std::cout << "                 -\\  \\     /  /-        " << std::endl;
        std::cout << "                   \\  \\   /  /          " << std::endl;
        std::cout << "Yeah! Nice hit on " << position << "!" << rang::style::reset << std::endl;
      }
      else
      {
